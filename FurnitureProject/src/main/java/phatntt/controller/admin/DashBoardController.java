    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (start != null && end != null) {
                // Nếu có start và end parameters, tính doanh thu hàng ngày
                List<ChartDTO> dailyRevenueList = dao.calculateDailyRevenue(start, end);
                Gson gson = new Gson();
                String json = gson.toJson(dailyRevenueList);
                out.println(json);
            } else {
                ...
                Gson gson = new Gson();
                String json = gson.toJson(completeRevenueByMonthList);
                out.println(json);
            }
