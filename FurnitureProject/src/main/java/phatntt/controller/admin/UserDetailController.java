...
import phatntt.controller.products.LoadProductDetailController;
...
public class UserDetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            UsersDTO dto = dao.getUserById(userId);

            // Đặt thông tin sản phẩm vào request attribute
            request.setAttribute("USER_DETAIL", dto);

            //set url
            url = siteMaps.getProperty(Constants.AdminFeatures.VIEW_DETAIL_ACCOUNT)
                    + "?Id=" + userId;
