        ...
        if (categoryIdStr != null) {
            try {
                ...
                for (ProductsDTO product : listProductsByCategoryId) {
                    ...
                    out.append("                                <a onclick=\"addProductToWishlist("+product.getProductId()+")\" class=\"btn-compare js-btn-wishlist setWishlist btn-views\" data-wish=\"bon-tam-massage-dat-goc\" tabindex=\"0\" title=\"Thêm vào yêu thích\">");
