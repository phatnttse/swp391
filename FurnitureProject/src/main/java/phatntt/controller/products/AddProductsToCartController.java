            ...
            if (result) {
                ...
                for (CartDTO cart : carts) {
                    out.println("            <div class=\"ajaxcart__row\">\n"
                            ...
                            + "                                    <button type=\"button\" class=\"ajaxcart__qty-adjust ajaxcart__qty--minus items-count\">-</button>\n"
                            + "                                    <input type=\"text\" name=\"\" class=\"ajaxcart__qty-num number-sidebar\" value=\"" + cart.getQuantity() + "\" pattern=\"[0-9]*\"/>\n"
                            + "                                    <button type=\"button\" class=\"ajaxcart__qty-adjust ajaxcart__qty--plus items-count\">+</button>\n"
                            + "                                </div>\n"
                            + "                            </div>\n"
                            + "                        </div>\n"
                            + "                        <div class=\"grid\">\n"
