 ...
 * @author mac
 */
@WebServlet(name="SortCategoryByStaffController", urlPatterns={"/SortCategoryByStaffController"})
public class SortCategoryByStaffController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SortCategoryByStaffController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SortCategoryByStaffController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            url = siteMaps.getProperty(Constants.Management.CATEGORY_MANAGEMENT_PAGE)
                    + "?typeSort=" + typeSort;
