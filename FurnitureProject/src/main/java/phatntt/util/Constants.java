...
public class Constants {
    ...
    public class SignUpFeatures {
        ...
        public static final String EMAIL_EXISTED_ERR_MESSAGE = "emailExistedErrMessage";
        public static final String PASSWORD_LENGTH_ERR_MESSAGE = "passwordLengthErrMessage";
        public static final String CONFIRM_NOTMATCHED_ERR_MESSAGE= "confirmNotMatchedErrMessage";     
        public static final String FULLNAME_LENGTH_ERR_MESSAGE= "fullnameLengthErrMessage";
        public static final String PHONE_LENGTH_ERR_MESSAGE= "phoneLengthErrMessage";
        public static final String USERVERIFY_CONTROLLER = "userVerifyController";
    }
