...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/FurnitureProject/assets/css/header3.css">
    ...
    <body>
        <div class="banner-top">
            <div class="container">
                <div class="cover">
                    <a href="/collections/all" title="Lofi Furniture"><img
                        ...
                        <div class="col-xl-3 col-lg-3 col-6 header-control">
                            <div class="ul-control">
                                ...
                                <div class="header-cart block-cart">
                                    <a href="cartPage" aria-label="Giỏ hàng" title="Giỏ hàng">
